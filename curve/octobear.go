...
import (
	...
	"github.com/yelhousni/octobear/curve/internal/fptower"
)

// Name is the curve identifier used in this standalone artifact in lieu of
// gnark-crypto's ecc.ID enum (which has no OCTOBEAR entry in v0.20.1).
const Name = "octobear"
